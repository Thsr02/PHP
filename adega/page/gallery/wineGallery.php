...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navBar">
            ...
            <a class="navbar-brand" href="#">
                ...
                <form class="d-flex" role="search" action="../../checkForm/searchWine.php" method="$_GET">
    ...
    $sql = "SELECT * FROM tbl_wines, tbl_producer WHERE prod_id = vin_producer AND vin_userId = $_SESSION[id] AND vin_show = 0";
        ...
        $vin_classification = $result['vin_classification'];
                            ...
                            <tbody style="word-break: break-word;">
                                <tr>
                                    ...
                                    <td><button><a
                                                href="../register/edit/editRegisterWine.php?win_id=<?php echo $vin_id; ?>"><svg
                                    ...
                                    <td><button><a href="../../checkForm/delete/wineDelete.php?command=1&&win_id=<?php echo $vin_id; ?>"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
