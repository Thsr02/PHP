...
<body>
    ...
    $sql = "SELECT * FROM tbl_region WHERE reg_userId = $_SESSION[id]";
        ...
        $reg_name = $result['reg_name'];
                            ...
                            <tbody style="word-break: break-word;">
                                <tr>
                                    ...
                                    <td><button><a
                                                href="../register/editRegisterWine.php?win_id=<?php echo $reg_id; ?>"><svg
                                    ...
                                    <td><button><a href="../../checkForm/delete.php?win_id=<?php echo $reg_id; ?>"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
