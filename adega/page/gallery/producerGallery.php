...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navBar">
            ...
            <a class="navbar-brand" href="#">
                ...
                <form class="d-flex" role="search" action="../../checkForm/search.php" method="$_GET">
    ...
    $sql = "SELECT * FROM tbl_producer, tbl_region WHERE reg_id = prod_region AND prod_userId = $_SESSION[id]";
    ...
    while ($result = $res->fetch(PDO::FETCH_ASSOC)) {
        ...
        $prod_region = $result['prod_region'];
                            ...
                            <tbody style="word-break: break-word;">
                                <tr>
                                    ...
                                    <td><button><a
                                                href="../register/editRegisterWine.php?win_id=<?php echo $prod_id; ?>"><svg
                                    ...
                                    <td><button><a href="../../checkForm/delete.php?win_id=<?php echo $prod_id; ?>"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
