...
<head>
    ...
    <title>Galeria de produtores</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navBar">
            ...
            <a class="navbar-brand" href="#">
                ...
                <form class="d-flex" role="search" action="../../checkForm/searchProducer.php" method="$_GET">
    ...
    $sql = "SELECT * FROM tbl_producer, tbl_region WHERE reg_id = prod_region AND prod_userId = $_SESSION[id] AND prod_show = 0";
        ...
        $prod_region = $result['reg_name'];
                            ...
                            <tbody style="word-break: break-word;">
                                <tr>
                                    ...
                                    <td><button><a
                                                href="../register/edit/editRegisterProducer.php?prodSelect=<?php echo $prod_id; ?>"><svg
                                    ...
                                    <td><button><a href="../../checkForm/delete/producerDelete.php?prodSelect=<?php echo $prod_id; ?>"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
