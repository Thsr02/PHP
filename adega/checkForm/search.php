...
if (!isset($_SESSION['email']) == true and (!isset($_SESSION['password']) == true)) {
    ...
    if (empty($_GET['inputSearch'])) {
        ...
        $res = $connection->prepare('SELECT * FROM tbl_wines, tbl_producer WHERE vin_userId = :userId AND prod_id = vin_producer AND vin_name LIKE "%":inputSearch"%" ');
                ...
                $vin_classification = $result['vin_classification'];
                        ...
                        <tbody style="word-break: break-word;">
                            <tr>
                                ...
                                <td><button><a href="../page/editRegisterWine.php?win_id=<?php echo $vin_id; ?>"><svg
