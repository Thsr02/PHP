            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="../pg/tela1.php">Perfil <img src="assets/images/profile-header.jpg" alt=""></a></li>
                    </ul>   
            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="header-text">
                  <h6>Bem Vindo ao ÉMeuSim</h6>
                  <h4><em>Galeria</em> onde não deixamos você esquecer nada</h4>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="heading-section">
                  <h4><em>Seus Itens</em> Bem aqui</h4>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="assets/images/popular-01.jpg" alt="">
                      <h4>GOL G5<br><span>2009 bala</span></h4>
                      <ul>
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      ...
                      <h4>Titanzinha zika<br><span>150tinha bala</span></h4>
                      <ul>
                        <li><i class="fa fa-star"></i> 4.8</li>
                        <li><i class="fa fa-download"></i> 2.3M</li>
                      </ul>
                  ...
                  <div class="col-lg-12">
                    <div class="main-button">
                      <a href="../pg/formulario.php">Cadastrar novo item</a>
                    </div>
                  </div>
                </div>
              </div>
